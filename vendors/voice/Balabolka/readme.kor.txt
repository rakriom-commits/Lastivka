...
라이선스: 프리웨어
운영 체제: Microsoft Windows XP/Vista/7/8/10/11
...
*** 포터블 버전 ***
    ...
    포터블 Balabolka는 설치가 필요 없으며 USB 드라이브에서 실행할 수 있습니다.
    컴퓨터에 최소 하나의 음성 프로그램이 설치되어 있어야 합니다.
